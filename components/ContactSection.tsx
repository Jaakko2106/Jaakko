                ...
                <div className="flex justify-center gap-6 mb-10 animate-on-scroll fade-in" style={{ transitionDelay: '0.25s' }}>
                    {[
                        ...
                        <a 
                            key={idx}
                            href="#" 
                            className={`text-gray-500 dark:text-gray-400 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 hover:rotate-3 p-2 rounded-full hover:bg-white/50 dark:hover:bg-gray-700/50 hover:shadow-lg ${item.color}`}
